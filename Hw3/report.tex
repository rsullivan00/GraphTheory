...
\begin{homeworkProblem}
    ...
    \begin{tikzpicture}
        \node[main node] (a) {};
        \node[main node] (b) [right= 1cm of a] {};
        \node[main node] (c) [above= 1cm of b] {};
        \node[main node] (d) [below= 1cm of b] {};
        \node[main node] (e) [right= 1cm of b] {};

        \node[main node] (f) [right= 1cm of e] {};
        \node[main node] (g) [right= 1cm of f] {};
        \node[main node] (h) [above= 1cm of g] {};
        \node[main node] (i) [below= 1cm of g] {};
        \node[main node] (j) [right= 1cm of g] {};
